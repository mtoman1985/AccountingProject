...
class ProjectAddDialog extends StatefulWidget {
  ...
  ProjectAddDialog({
    ...
    required this.personNmae,
    required this.positiveBtnPressed,
  });
  @override
  State<StatefulWidget> createState() => _ProjectAddDialogState();
}
...
class _ProjectAddDialogState extends State<ProjectAddDialog> {
  ...
  final String title = "إضافة مشروع جديد";
  int selectedIndex=0;
      ...
      children: [
        ...
        TextFormField(
          ...
          onEditingComplete: () {
            ...
            projectName = _projectName.text.toString();
            //_projectCurrency.;
          },
          textDirection: TextDirection.rtl,
            ...
            return DropdownMenuItem(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    //Icon(Icons.account_circle_rounded,color: Colors.green,),
                    Text(
                      e,
                      style: const TextStyle(
                        color: Colors.green,
      ...
      children: <Widget>[
        ...
        TextButton(
          onPressed: () {
            ...
            dbPerson.addPersons(_projectName.text, _projectCurrency.toString());
            ProjectAddDialog positiveBtnPressed;
